...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  void initState() {
    super.initState();
    //ref.read(productProvider.notifier).fetchProduct1();
    //ref.read(productProvider.notifier).fetchAll();
  ...
  Widget build(BuildContext context) {
    ...
    // Trigger fetchAll() ở init (HookWidget / initState trong StatefulWidget)
    // ref.read(productProvider.notifier).fetchAll();
