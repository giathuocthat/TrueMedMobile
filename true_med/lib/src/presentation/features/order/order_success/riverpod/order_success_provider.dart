...
class OrderSuccess extends _$OrderSuccess {
  ...
  OrderSuccessState build() {
    ...
    if (user == null) {
      return const OrderSuccessState(status: Status.initial);
    }
    _customer = user;
