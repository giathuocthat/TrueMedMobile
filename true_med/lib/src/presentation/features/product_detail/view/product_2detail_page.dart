...
class Product2DetailPage extends ConsumerStatefulWidget {
  final int productId;
  const Product2DetailPage({super.key, required this.productId});

  @override
  ConsumerState<Product2DetailPage> createState() => _Product2DetailPageState();
}

class _Product2DetailPageState extends ConsumerState<Product2DetailPage> {
